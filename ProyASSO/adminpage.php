...
<body>
    ...
    <div class="secciones" style="margin-top: 17%;">
        <div class="row justify-content-around  seccion">
            <div class="col-2">
                <div class="card" style="height: 100%; width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            CRUD para administrar al personal total de las diferentes franquicias
                        </p>
                    </div>
            ...
            <div class="col-2">
                <div class="card" style="height: 100%; width: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            CRUD para administrar los locales de la franqicia exceptuando la opcion de eliminar<br>
                        </p>
                    </div>
