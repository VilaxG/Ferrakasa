                ...
                <div class="d-flex ">
                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                        ...
                        <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="true">Ventas del ultimo mes</button>
                        <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                            data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile"
                            aria-selected="false">MReporte de reabastecimiento</button>
            ...
            <div class="col-10">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                        ...
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Porro incidunt a dicta magni cum sit
                        tenetur repellendus, inventore reprehenderit recusandae!
                    </div>
